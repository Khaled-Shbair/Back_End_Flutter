...
class RegisterApiScreen extends StatefulWidget {
  const RegisterApiScreen({Key? key}) : super(key: key);

  @override
  State<RegisterApiScreen> createState() => _RegisterApiScreenState();
}

class _RegisterApiScreenState extends State<RegisterApiScreen> with Helpers {
